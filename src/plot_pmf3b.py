...
# thresh1 = thresh[(X, W, 0, 6, 0, 3)]
# print (thresh1)
# plt.vlines(x=thresh1, ymin=0, ymax=ymax, colors='green', linewidth=0.5, linestyle='dashed')

thresh2 = [-np.inf] + np.arange(0, 32, 2).tolist() + [np.inf]
thresh2 = np.array(thresh2)
print (thresh2)
plt.vlines(x=thresh2, ymin=0, ymax=ymax, colors='black', linewidth=0.5, linestyle='dashed')
...
plt.savefig('adc_pmf2b.png', dpi=500, transparent=True)
