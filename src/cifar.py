...
def create_model(array_params):
    ...
    MaxPool(input_size=(32, 32, 64), kernel_size=2, stride=2, params=array_params, weights=weights),
    ...
    MaxPool(input_size=(16, 16, 128), kernel_size=2, stride=2, params=array_params, weights=weights),
    ...
    MaxPool(input_size=(8, 8, 128), kernel_size=2, stride=2, params=array_params, weights=weights),
