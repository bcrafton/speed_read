...
ylim = np.max(y_mac_per_cycle[1, 1, 1, 1, 1])

####################

cards_none = np.around(y_mac_per_cycle[1, 1, 0, 0, 0],  3)
cards_layer = np.around(y_mac_per_cycle[1, 1, 0, 1, 0],  3)
cards_block = np.around(y_mac_per_cycle[1, 1, 1, 1, 0],  3)
...
cards_none = np.around(y_mac_per_cycle[1, 1, 0, 0, 1],  3)
cards_layer = np.around(y_mac_per_cycle[1, 1, 0, 1, 1],  3)
cards_block = np.around(y_mac_per_cycle[1, 1, 1, 1, 1],  3)
