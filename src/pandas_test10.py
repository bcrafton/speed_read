...
for cards, rpr_alloc in [(1, 'static'), (1, 'dynamic'), (0, 'dynamic')]:
    ...
    ax1.plot(sigmas, mac_per_cycles, label='%s, %d' % (rpr_alloc, cards))
    ax2.plot(sigmas, errors, label='%s, %d' % (rpr_alloc, cards))
